  ...
  <ion-page>
    ...
    <ion-content>
      ...
      <div class="category-slider ion-padding-start">
        ...
        >
          <ion-slide
            v-for="category in $store.state.cetegories"
            :key="category.id"
          >
            <ion-col>
              <h4>{{ category.name }}</h4>
      ...
      <div class="product-slider ion-padding-start">
        ...
        >
          <ion-slide
            v-for="product in $store.state.featuredProducts"
            :key="product.id"
          >
            <ion-col
              class="ion-text-left"
      ...
      <div class="product-slider ion-padding-start">
        ...
        >
          <ion-slide
            v-for="product in $store.state.bestSellProducts"
            :key="product.id"
          >
            <ion-col
              class="ion-text-left"
...
import {logoVenmo,addOutline, notificationsOutline, funnelOutline } from "ionicons/icons";

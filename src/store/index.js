...
const store = createStore({
  ...
  state: {
    ...
    cetegories: [
      ...
      { id: 4, name: 'Womens', image: 'assets/categories/category-1.png' },
      { id: 5, name: 'Mens', image: 'assets/categories/category-2.png' },
      { id: 6, name: 'Kids', image: 'assets/categories/category-3.png' },
    ],
